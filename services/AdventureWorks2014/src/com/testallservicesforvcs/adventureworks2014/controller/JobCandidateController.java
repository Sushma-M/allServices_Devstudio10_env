...
public class JobCandidateController {
    ...
    @ApiOperation(value = "Partially updates the JobCandidate instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public JobCandidate patchJobCandidate(@PathVariable("id") Integer id, @RequestBody Map<String, Object> jobCandidatePatch) {
        LOGGER.debug("Partially updating JobCandidate with id: {}" , id);

        JobCandidate jobCandidate = jobCandidateService.partialUpdate(id, jobCandidatePatch);
        LOGGER.debug("JobCandidate details after partial update: {}" , jobCandidate);
