...
public class DepartmentController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Department getDepartment(@PathVariable("id") Short id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Department editDepartment(@PathVariable("id") Short id, @RequestBody Department department) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Department patchDepartment(@PathVariable("id") Short id, @RequestBody Map<String, Object> departmentPatch) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteDepartment(@PathVariable("id") Short id) {
