...
public class EmployeeDepartmentHistoryController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public EmployeeDepartmentHistory getEmployeeDepartmentHistory(@RequestParam("startDate") Date startDate, @RequestParam("businessEntityId") Integer businessEntityId, @RequestParam("shiftId") Short shiftId, @RequestParam("departmentId") Short departmentId) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public EmployeeDepartmentHistory editEmployeeDepartmentHistory(@RequestParam("startDate") Date startDate, @RequestParam("businessEntityId") Integer businessEntityId, @RequestParam("shiftId") Short shiftId, @RequestParam("departmentId") Short departmentId, @RequestBody EmployeeDepartmentHistory employeeDepartmentHistory) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteEmployeeDepartmentHistory(@RequestParam("startDate") Date startDate, @RequestParam("businessEntityId") Integer businessEntityId, @RequestParam("shiftId") Short shiftId, @RequestParam("departmentId") Short departmentId) {
    ...
    public Page<EmployeeDepartmentHistory> searchEmployeeDepartmentHistoriesByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering EmployeeDepartmentHistories list by query filter:{}", (Object) queryFilters);
    ...
    public Page<EmployeeDepartmentHistory> findEmployeeDepartmentHistories(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering EmployeeDepartmentHistories list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    @XssDisable
    public StringWrapper exportEmployeeDepartmentHistoriesAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = EmployeeDepartmentHistory.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> employeeDepartmentHistoryService.export(exportOptions, pageable, outputStream));
