...
public class EmployeeController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Employee patchEmployee(@PathVariable("id") Integer id, @RequestBody Map<String, Object> employeePatch) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Employee editEmployee(@PathVariable("id") Integer id, MultipartHttpServletRequest multipartHttpServletRequest) {
