...
import com.testallservicesforvcs.adventureworks2014.service.EmployeePayHistoryService;
...
public class EmployeePayHistoryController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public EmployeePayHistory editEmployeePayHistory(@RequestParam("businessEntityId") Integer businessEntityId, @RequestParam("rateChangeDate") LocalDateTime rateChangeDate, @RequestBody EmployeePayHistory employeePayHistory) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteEmployeePayHistory(@RequestParam("businessEntityId") Integer businessEntityId, @RequestParam("rateChangeDate") LocalDateTime rateChangeDate) {
    ...
    public Page<EmployeePayHistory> searchEmployeePayHistoriesByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering EmployeePayHistories list by query filter:{}", (Object) queryFilters);
    ...
    public Page<EmployeePayHistory> findEmployeePayHistories(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering EmployeePayHistories list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    @XssDisable
    public StringWrapper exportEmployeePayHistoriesAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = EmployeePayHistory.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> employeePayHistoryService.export(exportOptions, pageable, outputStream));
