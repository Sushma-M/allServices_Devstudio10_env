...
public class ShiftController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Shift getShift(@PathVariable("id") Short id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Shift editShift(@PathVariable("id") Short id, @RequestBody Shift shift) {
    ...
    @ApiOperation(value = "Partially updates the Shift instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Shift patchShift(@PathVariable("id") Short id, @RequestBody Map<String, Object> shiftPatch) {
        LOGGER.debug("Partially updating Shift with id: {}" , id);

        Shift shift = shiftService.partialUpdate(id, shiftPatch);
        LOGGER.debug("Shift details after partial update: {}" , shift);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteShift(@PathVariable("id") Short id) {
    ...
    public Page<Shift> searchShiftsByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering Shifts list by query filter:{}", (Object) queryFilters);
    ...
    public Page<Shift> findShifts(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering Shifts list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    @XssDisable
    public StringWrapper exportShiftsAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = Shift.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> shiftService.export(exportOptions, pageable, outputStream));
