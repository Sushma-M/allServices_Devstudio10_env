...
public interface VjobCandidateEducationService {
    ...
    /**
     * Partially updates the details of an existing VjobCandidateEducation. It updates only the
     * fields of the existing VjobCandidateEducation which are passed in the vjobCandidateEducationPatch.
     *
     * This method overrides the input field values using Server side or database managed properties defined on VjobCandidateEducation if any.
     *
     * @param vjobcandidateeducationId The id of the VjobCandidateEducation to be deleted; value cannot be null.
     * @param vjobCandidateEducationPatch The partial data of VjobCandidateEducation which is supposed to be updated; value cannot be null.
     * @return The updated VjobCandidateEducation.
     * @throws EntityNotFoundException if no VjobCandidateEducation is found with given input.
     */
    VjobCandidateEducation partialUpdate(VjobCandidateEducationId vjobcandidateeducationId, Map<String, Object> vjobCandidateEducationPatch);
