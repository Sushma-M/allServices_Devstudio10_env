...
public class ShiftServiceImpl implements ShiftService {
    ...
    @Transactional(value = "AdventureWorks2014TransactionManager")
    @Override
    public Shift partialUpdate(Short shiftIdInstance, Map<String, Object>shiftPatch) {
        LOGGER.debug("Partially Updating the Shift with id: {}", shiftIdInstance);
        
        Shift shift = getById(shiftIdInstance);

        try {
            ObjectReader shiftReader = this.objectMapper.readerForUpdating(shift);
            shift = shiftReader.readValue(this.objectMapper.writeValueAsString(shiftPatch));
        } catch (IOException ex) {
            LOGGER.debug("There was a problem in applying the patch: {}", shiftPatch, ex);
    ...
    public Shift delete(Short shiftIdInstance) {
        ...
        if (deleted == null) {
            ...
            throw new EntityNotFoundException(MessageResource.create("com.wavemaker.runtime.entity.not.found"), Shift.class.getSimpleName(), shiftIdInstance);
        }
