...
public class VemployeeDepartmentHistoryServiceImpl implements VemployeeDepartmentHistoryService {
    ...
    @Transactional(value = "AdventureWorks2014TransactionManager")
    @Override
    public VemployeeDepartmentHistory partialUpdate(VemployeeDepartmentHistoryId vemployeedepartmenthistoryId, Map<String, Object>vemployeeDepartmentHistoryPatch) {
        LOGGER.debug("Partially Updating the VemployeeDepartmentHistory with id: {}", vemployeedepartmenthistoryId);
        
        VemployeeDepartmentHistory vemployeeDepartmentHistory = getById(vemployeedepartmenthistoryId);

        try {
            ObjectReader vemployeeDepartmentHistoryReader = this.objectMapper.readerForUpdating(vemployeeDepartmentHistory);
            vemployeeDepartmentHistory = vemployeeDepartmentHistoryReader.readValue(this.objectMapper.writeValueAsString(vemployeeDepartmentHistoryPatch));
        } catch (IOException ex) {
            LOGGER.debug("There was a problem in applying the patch: {}", vemployeeDepartmentHistoryPatch, ex);
            throw new InvalidInputException("Could not apply patch",ex);
        }

        vemployeeDepartmentHistory = update(vemployeeDepartmentHistory);
    ...
    public VemployeeDepartmentHistory delete(VemployeeDepartmentHistoryId vemployeedepartmenthistoryId) {
        ...
        if (deleted == null) {
            ...
            throw new EntityNotFoundException(MessageResource.create("com.wavemaker.runtime.entity.not.found"), VemployeeDepartmentHistory.class.getSimpleName(), vemployeedepartmenthistoryId);
        }
