...
public class VjobCandidateEducationServiceImpl implements VjobCandidateEducationService {
    ...
    @Transactional(value = "AdventureWorks2014TransactionManager")
    @Override
    public VjobCandidateEducation partialUpdate(VjobCandidateEducationId vjobcandidateeducationId, Map<String, Object>vjobCandidateEducationPatch) {
        LOGGER.debug("Partially Updating the VjobCandidateEducation with id: {}", vjobcandidateeducationId);
        
        VjobCandidateEducation vjobCandidateEducation = getById(vjobcandidateeducationId);

        try {
            ObjectReader vjobCandidateEducationReader = this.objectMapper.readerForUpdating(vjobCandidateEducation);
            vjobCandidateEducation = vjobCandidateEducationReader.readValue(this.objectMapper.writeValueAsString(vjobCandidateEducationPatch));
        } catch (IOException ex) {
            LOGGER.debug("There was a problem in applying the patch: {}", vjobCandidateEducationPatch, ex);
            throw new InvalidInputException("Could not apply patch",ex);
        }

        vjobCandidateEducation = update(vjobCandidateEducation);
    ...
    public VjobCandidateEducation delete(VjobCandidateEducationId vjobcandidateeducationId) {
        ...
        if (deleted == null) {
            ...
            throw new EntityNotFoundException(MessageResource.create("com.wavemaker.runtime.entity.not.found"), VjobCandidateEducation.class.getSimpleName(), vjobcandidateeducationId);
        }
