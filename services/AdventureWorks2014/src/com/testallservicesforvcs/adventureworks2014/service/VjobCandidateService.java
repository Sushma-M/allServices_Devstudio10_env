...
public interface VjobCandidateService {
    ...
    /**
     * Partially updates the details of an existing VjobCandidate. It updates only the
     * fields of the existing VjobCandidate which are passed in the vjobCandidatePatch.
     *
     * This method overrides the input field values using Server side or database managed properties defined on VjobCandidate if any.
     *
     * @param vjobcandidateId The id of the VjobCandidate to be deleted; value cannot be null.
     * @param vjobCandidatePatch The partial data of VjobCandidate which is supposed to be updated; value cannot be null.
     * @return The updated VjobCandidate.
     * @throws EntityNotFoundException if no VjobCandidate is found with given input.
     */
    VjobCandidate partialUpdate(VjobCandidateId vjobcandidateId, Map<String, Object> vjobCandidatePatch);
