...
public interface ShiftService {
     ...
     */
    Shift getById(Short shiftIdInstance);
	...
	/**
     * Find and return the list of Shifts by given id's.
     *
     ...
     *
     * @param shiftIdInstances The id's of the Shift to get; value cannot be null.
     * @param orderedReturn Should the return List be ordered and positional in relation to the incoming ids?
     * @return Shifts associated with the given shiftIdInstances.
     */
    List<Shift> findByMultipleIds(List<Short> shiftIdInstances, boolean orderedReturn);
     ...
     */
    Shift getByStartTimeAndEndTime(Time startTime, Time endTime);
     ...
     */
    Shift update(@Valid Shift shift);
    
    
    /**
     * Partially updates the details of an existing Shift. It updates only the
     * fields of the existing Shift which are passed in the shiftPatch.
     *
     * This method overrides the input field values using Server side or database managed properties defined on Shift if any.
     *
     * @param shiftIdInstance The id of the Shift to be deleted; value cannot be null.
     * @param shiftPatch The partial data of Shift which is supposed to be updated; value cannot be null.
     * @return The updated Shift.
     * @throws EntityNotFoundException if no Shift is found with given input.
     */
    Shift partialUpdate(Short shiftIdInstance, Map<String, Object> shiftPatch);
     ...
     */
    Shift delete(Short shiftIdInstance);

    /**
     * Deletes an existing Shift with the given object.
     *
     * @param shift The instance of the Shift to be deleted; value cannot be null.
     */
