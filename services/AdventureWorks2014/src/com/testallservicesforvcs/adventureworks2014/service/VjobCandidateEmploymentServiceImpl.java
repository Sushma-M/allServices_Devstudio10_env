...
public class VjobCandidateEmploymentServiceImpl implements VjobCandidateEmploymentService {
    ...
    @Transactional(value = "AdventureWorks2014TransactionManager")
    @Override
    public VjobCandidateEmployment partialUpdate(VjobCandidateEmploymentId vjobcandidateemploymentId, Map<String, Object>vjobCandidateEmploymentPatch) {
        LOGGER.debug("Partially Updating the VjobCandidateEmployment with id: {}", vjobcandidateemploymentId);
        
        VjobCandidateEmployment vjobCandidateEmployment = getById(vjobcandidateemploymentId);

        try {
            ObjectReader vjobCandidateEmploymentReader = this.objectMapper.readerForUpdating(vjobCandidateEmployment);
            vjobCandidateEmployment = vjobCandidateEmploymentReader.readValue(this.objectMapper.writeValueAsString(vjobCandidateEmploymentPatch));
        } catch (IOException ex) {
            LOGGER.debug("There was a problem in applying the patch: {}", vjobCandidateEmploymentPatch, ex);
            throw new InvalidInputException("Could not apply patch",ex);
        }

        vjobCandidateEmployment = update(vjobCandidateEmployment);
    ...
    public VjobCandidateEmployment delete(VjobCandidateEmploymentId vjobcandidateemploymentId) {
        ...
        if (deleted == null) {
            ...
            throw new EntityNotFoundException(MessageResource.create("com.wavemaker.runtime.entity.not.found"), VjobCandidateEmployment.class.getSimpleName(), vjobcandidateemploymentId);
        }
