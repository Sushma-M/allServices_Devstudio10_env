...
public interface VjobCandidateEmploymentService {
     ...
     */
    VjobCandidateEmployment getById(VjobCandidateEmploymentId vjobcandidateemploymentId);
	...
	/**
     * Find and return the list of VjobCandidateEmployments by given id's.
     *
     ...
     *
     * @param vjobcandidateemploymentIds The id's of the VjobCandidateEmployment to get; value cannot be null.
     * @param orderedReturn Should the return List be ordered and positional in relation to the incoming ids?
     * @return VjobCandidateEmployments associated with the given vjobcandidateemploymentIds.
     */
    List<VjobCandidateEmployment> findByMultipleIds(List<VjobCandidateEmploymentId> vjobcandidateemploymentIds, boolean orderedReturn);
     ...
     */
    VjobCandidateEmployment update(@Valid VjobCandidateEmployment vjobCandidateEmployment);
    
    
    /**
     * Partially updates the details of an existing VjobCandidateEmployment. It updates only the
     * fields of the existing VjobCandidateEmployment which are passed in the vjobCandidateEmploymentPatch.
     *
     * This method overrides the input field values using Server side or database managed properties defined on VjobCandidateEmployment if any.
     *
     * @param vjobcandidateemploymentId The id of the VjobCandidateEmployment to be deleted; value cannot be null.
     * @param vjobCandidateEmploymentPatch The partial data of VjobCandidateEmployment which is supposed to be updated; value cannot be null.
     * @return The updated VjobCandidateEmployment.
     * @throws EntityNotFoundException if no VjobCandidateEmployment is found with given input.
     */
    VjobCandidateEmployment partialUpdate(VjobCandidateEmploymentId vjobcandidateemploymentId, Map<String, Object> vjobCandidateEmploymentPatch);
     ...
     */
    VjobCandidateEmployment delete(VjobCandidateEmploymentId vjobcandidateemploymentId);
