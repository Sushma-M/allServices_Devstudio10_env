...
public interface EmployeeDepartmentHistoryService {
    ...
    /**
     * Partially updates the details of an existing EmployeeDepartmentHistory. It updates only the
     * fields of the existing EmployeeDepartmentHistory which are passed in the employeeDepartmentHistoryPatch.
     *
     * This method overrides the input field values using Server side or database managed properties defined on EmployeeDepartmentHistory if any.
     *
     * @param employeedepartmenthistoryId The id of the EmployeeDepartmentHistory to be deleted; value cannot be null.
     * @param employeeDepartmentHistoryPatch The partial data of EmployeeDepartmentHistory which is supposed to be updated; value cannot be null.
     * @return The updated EmployeeDepartmentHistory.
     * @throws EntityNotFoundException if no EmployeeDepartmentHistory is found with given input.
     */
    EmployeeDepartmentHistory partialUpdate(EmployeeDepartmentHistoryId employeedepartmenthistoryId, Map<String, Object> employeeDepartmentHistoryPatch);
