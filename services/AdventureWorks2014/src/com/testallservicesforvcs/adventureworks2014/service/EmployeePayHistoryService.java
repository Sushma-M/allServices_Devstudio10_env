...
public interface EmployeePayHistoryService {
     ...
     */
    EmployeePayHistory getById(EmployeePayHistoryId employeepayhistoryId);
	...
	/**
     * Find and return the list of EmployeePayHistories by given id's.
     *
     ...
     *
     * @param employeepayhistoryIds The id's of the EmployeePayHistory to get; value cannot be null.
     * @param orderedReturn Should the return List be ordered and positional in relation to the incoming ids?
     * @return EmployeePayHistories associated with the given employeepayhistoryIds.
     */
    List<EmployeePayHistory> findByMultipleIds(List<EmployeePayHistoryId> employeepayhistoryIds, boolean orderedReturn);
     ...
     */
    EmployeePayHistory update(@Valid EmployeePayHistory employeePayHistory);
    
    
    /**
     * Partially updates the details of an existing EmployeePayHistory. It updates only the
     * fields of the existing EmployeePayHistory which are passed in the employeePayHistoryPatch.
     *
     * This method overrides the input field values using Server side or database managed properties defined on EmployeePayHistory if any.
     *
     * @param employeepayhistoryId The id of the EmployeePayHistory to be deleted; value cannot be null.
     * @param employeePayHistoryPatch The partial data of EmployeePayHistory which is supposed to be updated; value cannot be null.
     * @return The updated EmployeePayHistory.
     * @throws EntityNotFoundException if no EmployeePayHistory is found with given input.
     */
    EmployeePayHistory partialUpdate(EmployeePayHistoryId employeepayhistoryId, Map<String, Object> employeePayHistoryPatch);
     ...
     */
    EmployeePayHistory delete(EmployeePayHistoryId employeepayhistoryId);

    /**
     * Deletes an existing EmployeePayHistory with the given object.
     *
     * @param employeePayHistory The instance of the EmployeePayHistory to be deleted; value cannot be null.
     */
    void delete(EmployeePayHistory employeePayHistory);
