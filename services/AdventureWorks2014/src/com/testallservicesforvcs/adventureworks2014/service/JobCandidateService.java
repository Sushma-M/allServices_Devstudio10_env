...
public interface JobCandidateService {
     ...
     */
    JobCandidate getById(Integer jobcandidateId);
	...
	/**
     * Find and return the list of JobCandidates by given id's.
     *
     ...
     *
     * @param jobcandidateIds The id's of the JobCandidate to get; value cannot be null.
     * @param orderedReturn Should the return List be ordered and positional in relation to the incoming ids?
     * @return JobCandidates associated with the given jobcandidateIds.
     */
    List<JobCandidate> findByMultipleIds(List<Integer> jobcandidateIds, boolean orderedReturn);
     ...
     */
    JobCandidate update(@Valid JobCandidate jobCandidate);
    
    
    /**
     * Partially updates the details of an existing JobCandidate. It updates only the
     * fields of the existing JobCandidate which are passed in the jobCandidatePatch.
     *
     * This method overrides the input field values using Server side or database managed properties defined on JobCandidate if any.
     *
     * @param jobcandidateId The id of the JobCandidate to be deleted; value cannot be null.
     * @param jobCandidatePatch The partial data of JobCandidate which is supposed to be updated; value cannot be null.
     * @return The updated JobCandidate.
     * @throws EntityNotFoundException if no JobCandidate is found with given input.
     */
    JobCandidate partialUpdate(Integer jobcandidateId, Map<String, Object> jobCandidatePatch);
     ...
     */
    JobCandidate delete(Integer jobcandidateId);

    /**
     * Deletes an existing JobCandidate with the given object.
     *
     * @param jobCandidate The instance of the JobCandidate to be deleted; value cannot be null.
     */
