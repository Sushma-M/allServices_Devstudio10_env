...
public class VemployeeDepartmentServiceImpl implements VemployeeDepartmentService {
    ...
    @Transactional(value = "AdventureWorks2014TransactionManager")
    @Override
    public VemployeeDepartment partialUpdate(VemployeeDepartmentId vemployeedepartmentId, Map<String, Object>vemployeeDepartmentPatch) {
        LOGGER.debug("Partially Updating the VemployeeDepartment with id: {}", vemployeedepartmentId);
        
        VemployeeDepartment vemployeeDepartment = getById(vemployeedepartmentId);

        try {
            ObjectReader vemployeeDepartmentReader = this.objectMapper.readerForUpdating(vemployeeDepartment);
            vemployeeDepartment = vemployeeDepartmentReader.readValue(this.objectMapper.writeValueAsString(vemployeeDepartmentPatch));
        } catch (IOException ex) {
            LOGGER.debug("There was a problem in applying the patch: {}", vemployeeDepartmentPatch, ex);
            throw new InvalidInputException("Could not apply patch",ex);
        }

        vemployeeDepartment = update(vemployeeDepartment);
    ...
    public VemployeeDepartment delete(VemployeeDepartmentId vemployeedepartmentId) {
        ...
        if (deleted == null) {
            ...
            throw new EntityNotFoundException(MessageResource.create("com.wavemaker.runtime.entity.not.found"), VemployeeDepartment.class.getSimpleName(), vemployeedepartmentId);
        }
