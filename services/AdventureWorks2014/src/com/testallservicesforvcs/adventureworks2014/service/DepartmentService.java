...
public interface DepartmentService {
     ...
     */
    Department getById(Short departmentIdInstance);
     ...
     *
     * @param departmentIdInstances The id's of the Department to get; value cannot be null.
     * @param orderedReturn Should the return List be ordered and positional in relation to the incoming ids?
     * @return Departments associated with the given departmentIdInstances.
     */
    List<Department> findByMultipleIds(List<Short> departmentIdInstances, boolean orderedReturn);
     ...
     * @throws EntityNotFoundException if no Department is found with given input.
     */
    Department partialUpdate(Short departmentIdInstance, Map<String, Object> departmentPatch);
     ...
     */
    Department delete(Short departmentIdInstance);
