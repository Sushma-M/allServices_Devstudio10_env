...
public class DepartmentServiceImpl implements DepartmentService {
    ...
    @Transactional(value = "AdventureWorks2014TransactionManager")
    @Override
    public Department partialUpdate(Short departmentIdInstance, Map<String, Object>departmentPatch) {
        LOGGER.debug("Partially Updating the Department with id: {}", departmentIdInstance);
        
        Department department = getById(departmentIdInstance);
    ...
    public Department delete(Short departmentIdInstance) {
        ...
        if (deleted == null) {
            ...
            throw new EntityNotFoundException(MessageResource.create("com.wavemaker.runtime.entity.not.found"), Department.class.getSimpleName(), departmentIdInstance);
        }
