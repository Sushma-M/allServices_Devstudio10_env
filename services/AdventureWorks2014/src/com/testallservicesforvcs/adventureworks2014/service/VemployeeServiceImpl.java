...
public class VemployeeServiceImpl implements VemployeeService {
    ...
    @Transactional(value = "AdventureWorks2014TransactionManager")
    @Override
    public Vemployee partialUpdate(VemployeeId vemployeeId, Map<String, Object>vemployeePatch) {
        LOGGER.debug("Partially Updating the Vemployee with id: {}", vemployeeId);
        
        Vemployee vemployee = getById(vemployeeId);

        try {
            ObjectReader vemployeeReader = this.objectMapper.readerForUpdating(vemployee);
            vemployee = vemployeeReader.readValue(this.objectMapper.writeValueAsString(vemployeePatch));
        } catch (IOException ex) {
            LOGGER.debug("There was a problem in applying the patch: {}", vemployeePatch, ex);
            throw new InvalidInputException("Could not apply patch",ex);
        }

        vemployee = update(vemployee);
    ...
    public Vemployee delete(VemployeeId vemployeeId) {
        ...
        if (deleted == null) {
            ...
            throw new EntityNotFoundException(MessageResource.create("com.wavemaker.runtime.entity.not.found"), Vemployee.class.getSimpleName(), vemployeeId);
        }
